        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="File-based routing">
            <ThemedText type="small">
              This app uses nested Expo Router layouts for its root, main, Home,
              and Explore navigation boundaries.
            </ThemedText>
          ...
          <Collapsible title="Animations">
            <ThemedText type="small">
              ...
              <ThemedText type="code">Collapsible</ThemedText> component uses
